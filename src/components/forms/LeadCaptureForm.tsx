  ...
  if (submitted) {
    return (
      <div className="p-8 bg-green-50 border border-green-200 rounded-xl text-center">
        <p className="text-green-800 font-semibold">Merci ! Votre demande a �t� envoy�e.</p>
        <p className="text-sm text-green-700 mt-2">Vous recevrez le lien de t�l�chargement par email.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <Button type="submit" variant="primary" className="w-full">
        T�l�charger gratuitement la TEM 2026
      </Button>
      <p className="text-xs text-slate-500 text-center">Vos donn�es restent confidentielles et ne seront jamais partag�es.</p>
    </form>
  );
}
