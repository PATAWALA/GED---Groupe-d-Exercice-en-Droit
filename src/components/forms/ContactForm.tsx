  ...
  if (sent) {
    return (
      <div className="p-8 bg-green-50 border border-green-200 rounded-xl text-center">
        ...
        <p className="text-sm text-green-700 mt-2">Notre �quipe vous r�pondra sous 24h.</p>
      </div>
    );
  }
